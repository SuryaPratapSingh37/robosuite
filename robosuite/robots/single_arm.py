...
class SingleArm(Manipulator):
	...
	def _load_controller(self):
		...
		# print("_load_controller() single_arm.py")
		...
		#print(self.controller_config["type"])
	...
	def load_model(self):
		...
		# print("load_model() single_arm.py")
		super().load_model()
	...
	def setup_references(self):
		...
		# print("setup_references() single_arm.py")
	...
	def control(self, action, policy_step=False):
		...
		gripper_action = None
		if self.has_gripper:
			#print("has gripper",self.controller.control_dim)
			#print(self.robot)
			if self.controller.control_dim == 18: ##only for wombat_arm
		...
		# print("arm_action in single_arm.py",arm_action)
		# Now run the controller for a step
		torques = self.controller.run_controller()
		# print("torques in single_arm.py",torques)
		# Clip the torques
		low, high = self.torque_limits
		self.torques = np.clip(torques, low, high)
		print("torques in single_arm.py",self.torques)
		# Get gripper action, if applicable
		if self.has_gripper:
			self.grip_action(gripper=self.gripper, gripper_action=gripper_action)

		# Apply joint torque control
		#print("actuator_indexes",self._ref_joint_actuator_indexes)
		self.sim.data.ctrl[self._ref_joint_actuator_indexes] = self.torques
		# print("self.sim.data.ctrl in single_arm.py",self.sim.data.ctrl[:])
	...
	def _visualize_grippers(self, visible):
		...
		"""
		# print("_visualize_grippers() single_arm.py")
	...
	def setup_observables(self):
		...
		# print("setup_observables() single_arm.py")
	...
	def action_limits(self):
		...
		# print("action_limits() single_arm.py")
