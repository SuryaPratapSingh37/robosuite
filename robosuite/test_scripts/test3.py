...
while t<t_final:
	...
	# 		PD_signal[j]=-1
	#print(PD_signal)
	# if math.sqrt((ee_pose[0]+0.0587785)**2 + (ee_pose[1]-0.03175)**2 + (ee_pose[2]+0.61909)**2 + (ee_pose[3]-3.14159)**2 + (ee_pose[4]-0.0)**2 + (ee_pose[5]-3.14159)**2) < 0.001 :
	# 	time.sleep(2000)
...
# plt.figure(1)
# plt.title("Torques_branch1 rotary vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch1 rotary')
# plt.plot(t_arr,torque1,label="Torques_branch1 rotary")

# plt.figure(2)
# plt.title("Torques_branch2 rotary vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch2 rotary')
# plt.plot(t_arr,torque2,label="Torques_branch2 rotary")

# plt.figure(3)
# plt.title("Torques_branch3 rotary vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch3 rotary')
# plt.plot(t_arr,torque3,label="Torques_branch3 rotary")

# plt.figure(4)
# plt.title("Torques_branch1 linear vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch1 linear')
# plt.plot(t_arr,torque4,label="Torques_branch1 linear")

# plt.figure(5)
# plt.title("Torques_branch2 linear vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch2 linear')
# plt.plot(t_arr,torque5,label="Torques_branch2 linear")

# plt.figure(6)
# plt.title("Torques_branch3 linear vs time")
# plt.xlabel('time(s)')
# plt.ylabel('Torques_branch3 linear')
# plt.plot(t_arr,torque6,label="Torques_branch3 linear")
